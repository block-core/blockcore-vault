...
exports.ExplorerComponent = void 0;
...
let ExplorerComponent = class ExplorerComponent {
    ...
    updateBlocks() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.timerBlocks = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                yield this.updateBlocks();
            }), 15000);
        });
    }
    updateInfo() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.timerInfo = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                yield this.updateInfo();
            }), 15000);
        });
    }
...
], ExplorerComponent.prototype, "hostClass", void 0);

...
export class ValuesComponent implements OnDestroy {
  ...
  saveEdit() {
    ...
    if (this.item._id) {
      this.http.put<any>(this.baseUrl + 'api/storage/values/' + this.item._id, this.item).subscribe(result => {
      ...
      this.http.post<any>(this.baseUrl + 'api/storage/values/', this.item).subscribe(result => {
  ...
  loadItems() {
    this.http.get<any>(this.baseUrl + 'api/storage/values').subscribe(result => {

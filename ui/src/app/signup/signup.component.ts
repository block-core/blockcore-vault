...
export class SignupComponent implements OnDestroy {
  ...
  saveEdit() {
    ...
    if (this.message._id) {
      this.http.put<any>(this.baseUrl + 'api/storage/signup/' + this.message._id, this.message).subscribe(result => {
      ...
      this.http.post<any>(this.baseUrl + 'api/storage/signup/', this.message).subscribe(result => {
  ...
  loadMessages() {
    this.http.get<any>(this.baseUrl + 'api/storage/signup').subscribe(result => {

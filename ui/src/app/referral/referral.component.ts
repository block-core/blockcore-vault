...
export class ReferralComponent implements OnDestroy {
  ...
  saveEdit() {
    ...
    if (this.message._id) {
      this.http.put<any>(this.baseUrl + 'api/storage/referral/' + this.message._id, this.message).subscribe(result => {
      ...
      this.http.post<any>(this.baseUrl + 'api/storage/referral/', this.message).subscribe(result => {
  ...
  loadMessages() {
    this.http.get<any>(this.baseUrl + 'api/storage/referral').subscribe(result => {
